...
urlpatterns = [
    ...
    path('manajemen-bisnis/', profile_view_manajemen, name='manajemen-bisnis'),
    path('magister-manajemen/', profile_view_manajemens2, name='magister-manajemen'),
    path('akuntansi/', profile_view_akuntansi, name='akuntansi'),
    ...
    path('informatika/', profile_view_informatika, name='informatika'),
